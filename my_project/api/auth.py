...
from my_project.database.schema import UserProfileInputSchema, UserProfileOutSchema, UserLoginSchema
from sqlalchemy.orm import Session
from passlib.context import CryptContext
from fastapi.security import OAuth2PasswordBearer
from my_project.config import (SECRET_KEY, ALGORITHM,
...
async def register(user: UserProfileInputSchema, db: Session = Depends(get_db)):
    ...
    if user_db:
        ...
        raise HTTPException(detail='Мындай почта бар экен', status_code=400)
